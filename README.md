...
```
We have packaged our implementation into an easy-to-use Python library for use by the research community. The accompanying [tutorial]([https://spatialex-tutorials.readthedocs.io/en/latest](https://spatialex-tutorials.readthedocs.io/en/latest/Installation.html)) offers detailed guidance on how to use the package effectively.
### Prepare datasets
